...
int main(){
    ...
    */
    ...
    plt::ylabel("E");
    oss.str("");
    oss << "../../error_growth/time-error_beta" << params.beta << "nu" << params.nu << "t" << t << "dt" << dt << "repeat" << repetitions << "sampling" << sampling_rate << "perturbed dim" << perturbed_dim << ".png";  // 文字列を結合する
    ...
    plt::ylabel("E'/E");
    oss.str("");
    oss << "../../error_growth/time-rate_beta" << params.beta << "nu" << params.nu << "t" << t << "dt" << dt << "repeat" << repetitions << "sampling" << sampling_rate << "perturbed dim" << perturbed_dim << ".png";  // 文字列を結合する
    ...
    */
    ...
    oss2 << "../../error_growth/beta" << params.beta << "nu" << params.nu << "t" << t << "dt" << dt << "repeat" << repetitions << "sampling" << sampling_rate << "perturbed dim" << perturbed_dim << ".npy";  // 文字列を結合する
