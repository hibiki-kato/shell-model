...
int main(){
    ...
    const double check = 800;
    const double progress = 100;
    int limit = 2e+5; //limitation of trial of stagger and step
    Eigen::VectorXcd x_0 = npy2EigenVec<std::complex<double>>("../../initials/beta0.43_nu0.00018_631period_dt0.01eps0.002.npy");
    ...
    sync_pairs.push_back(std::make_tuple(11, 14, 1.3E-2));
        ...
        // otherwise, try stagger and step in parallel
            ...
            */
            ...
            for (int j = 0; j < limit; j++){
                ...
                Eigen::VectorXcd Local_x_0 = Local_LL.perturbation_(Local_SM.get_x_0_(), -8, -2);
